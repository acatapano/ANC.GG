...
const MatchDisplay = ({ matchInfo }: { matchInfo: any }) => {
  ...
  const getMatchOutcome = () => {
    if (
      matchInfo.blueTeam.stats.win &&
      matchInfo.blueTeam.stats.searchedPlayer
    ) {
      return "Victory";
    } else if (
      matchInfo.redTeam.stats.win &&
      matchInfo.redTeam.stats.searchedPlayer
    ) {
      return "Victory";
    }
    return "Defeat";
  ...
  return (
    <div>
      ...
      >
        <div
          className={[`flex flex-1 flex-col`, `bg-${matchColor}-100`].join(" ")}
        >
          <div className="flex flex-1 flex-col bg-[var(--game-item-color-100)] text-xs text-gray-500 md:flex-row md:items-center md:gap-2 md:p-1 md:px-3">
            <div className="flex flex-row-reverse items-center justify-between gap-2 border-b border-b-[var(--game-item-color-200)] py-0.5 pl-3 pr-0.5 md:w-[108px] md:flex-col md:items-baseline md:justify-normal md:border-none md:p-0">
              ...
              <div className="flex gap-2 md:flex-col md:gap-0">
                ...
                <span>
                  {" "}
                  {matchInfo.matchData.gameDurationMinutes}m{" "}
                  {matchInfo.matchData.gameDurationSeconds}s
                </span>
              </div>
            </div>
            <div className="flex flex-1 gap-0.5 py-1 pl-3 pr-2 md:p-0">
              <div className="flex flex-1 gap-2 flex-row md:flex-col">
                <div className="flex flex-1 items-center gap-2 md:gap-3">
                    ...
                    <div className="flex gap-0.5">
                      <div className="flex flex-col gap-0.5">
                        <img
                          ...
                          src={getSummonerSpellIcon(
                            searchedPlayerStats.summonerSpell1,
                          )}
                          style={{ color: "transparent" }}
                        ></img>
                        <img
                          ...
                          className="rounded size-[18px] md:size-[22px]"
                          src={getSummonerSpellIcon(
                            searchedPlayerStats.summonerSpell2,
                          )}
                          style={{ color: "transparent" }}
                        ></img>
                      </div>
                      <div className="flex flex-col gap-0.5">
                        <img
                          ...
                          src={getKeystoneIcon(
                            searchedPlayerStats.keystoneRune,
                          )}
                          style={{ color: "transparent" }}
                        ></img>
                        <img
                          ...
                          height="22"
                          className="rounded-full size-[18px] md:size-[22px]"
                          src={getSecondaryTreeIcon(
                            searchedPlayerStats.secondaryTree,
                          )}
                          style={{ color: "transparent" }}
                        ></img>
                      </div>
                  ...
                  <div className="flex flex-1 flex-col items-center gap-0.5 md:max-w-[114px] md:items-start">
                    <div className="flex items-center gap-1 text-[15px] leading-[22px]">
                      <strong className="text-gray-900">
                        {searchedPlayerStats.kills}
                      </strong>
                      /
                      <strong className="text-red-600">
                        {searchedPlayerStats.deaths}
                      </strong>
                      /
                      <strong className="text-gray-900">
                        {searchedPlayerStats.assists}
                      </strong>
                    </div>
                  ...
                  <div className="flex flex-1 flex-col items-center whitespace-nowrap text-2xs leading-[14px] max-[320px]:hidden md:min-h-[58px] md:w-[131px] md:items-baseline md:border-l md:border-[var(--game-item-color-200)] md:pl-2">
                    ...
                    <div>
                      CS {searchedPlayerStats.cs} (
                      {searchedPlayerStats.csPerMin})
                    </div>
                  </div>
                </div>
              ...
              <div className="hidden gap-1 md:flex">
                <div className="flex flex-col gap-0.5">
                  ...
                  {matchInfo.blueTeam.participants.map(
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  {matchInfo.redTeam.participants.map(
                    (participant: any, index: number) => (
                      <div key={index} className="flex items-center gap-1">
                        <img
                          alt=""
        ...
        <div className="relative hidden md:flex md:basis-10 md:flex-col">
          ...
          >
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="transition-transform duration-150 ease-out text-[var(--game-item-color-500)]"
            >
              <path
                fill="currentColor"
                fillRule="nonzero"
                    ...
                    <thead>
                      <tr>
                        <th scope="col" className="!bg-gray-0 text-left">
                          <span className="mr-[4px] font-bold text-main-500">
                            {getWin(matchInfo.blueTeam)}
                          </span>
                          (Blue Team)
                        </th>
                        <th scope="col" className="!bg-gray-0">
                          KDA
                        </th>
                        <th scope="col" className="!bg-gray-0">
                          Damage
                              ...
                              <div className="flex items-center gap-1">
                                <div>
                                  ...
                                  <div className="relative h-5 bg-gray-0 h-[6px] w-[50px]">
                                    <div
                                      className="absolute bottom-0 left-0 h-full bg-red-500 transition-all duration-300"
                                ...
                                <div>
                                  ...
                                  <div className="relative h-5 bg-gray-0 h-[6px] w-[50px]">
                                    <div
                                      className="absolute bottom-0 left-0 h-full bg-gray-400 transition-all duration-300"
                                      style={{ width: "100%", height: "100%" }}
                                    ></div>
                                  </div>
                                </div>
                ...
                <div className="flex flex-col items-center justify-between border-y border-gray-200 bg-gray-100 px-4 py-2 md:flex-row">
                  <div className="flex gap-x-1 md:max-w-[150px] md:flex-wrap">
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.blueTeam.stats.barons}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.blueTeam.stats.dragons}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <g
                              id="01-Icon-/-01-lol-/-icon_Herald"
                              transform="translate(1668 1020.167)"
                            >
                              <path
                                id="Combined-Shape"
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.blueTeam.stats.riftHeralds}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      >
                        <g id="icon_atakhan">
                          <g id="Union" fill="blue">
                            <path d="M8 0 6.476 3.048l.508 2.54L8 7.11l1.016-1.524.508-2.54zM6.476 5.587l-.508-2.031-2.031-1.524v2.031L2.413 5.587v1.016h1.016L4.952 5.08z"></path>
                            <path
                              fillRule="evenodd"
                              ...
                              clipRule="evenodd"
                            ></path>
                            <path d="m9.524 5.587.508-2.031 2.031-1.524v2.031l1.524 1.524v1.016h-1.016L11.048 5.08z"></path>
                          </g>
                        </g>
                      </svg>
                      <span className="min-w-[14px] text-center">
                        {matchInfo.blueTeam.stats.atakhan}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.blueTeam.stats.voidGrubs}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.blueTeam.stats.towers}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      >
                        <path
                          ...
                          clipRule="evenodd"
                        ></path>
                        <path fill="blue" d="m8 4 4 4-4 4-4-4z"></path>
                      </svg>
                      <span className="min-w-[14px] text-center">
                        {matchInfo.blueTeam.stats.inhibitors}
                      </span>
                    </div>
                  </div>
                  <div className="my-[6px] text-white md:m-0">
                    <div className="relative m-auto w-[300px] md:w-[383px]">
                      <div className="relative h-5 bg-gray-0 h-[16px] w-full text-[12px] !bg-red-500">
                        <div
                          className="absolute bottom-0 left-0 h-full bg-main-500 transition-all duration-300"
                          style={{ width: "60.4938%", height: "100%" }}
                        ></div>
                      </div>
                    ...
                    <div className="relative my-auto mt-1 w-[300px] md:w-[383px]">
                      <div className="relative h-5 bg-gray-0 h-[16px] w-full text-[12px] !bg-red-500">
                        <div
                          className="absolute bottom-0 left-0 h-full bg-main-500 transition-all duration-300"
                          style={{ width: "53.3301%", height: "100%" }}
                        ></div>
                      </div>
                  ...
                  <div className="flex gap-x-1 md:max-w-[150px] md:flex-wrap justify-end">
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.redTeam.stats.barons}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.redTeam.stats.dragons}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.redTeam.stats.riftHeralds}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.redTeam.stats.atakhan}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.redTeam.stats.voidGrubs}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      <span className="min-w-[14px] text-center">
                        {matchInfo.redTeam.stats.towers}
                      </span>
                    </div>
                    <div className="flex content-center gap-1 text-[12px] text-gray-500">
                      <svg
                      ...
                      >
                        <path
                          ...
                          clipRule="evenodd"
                        ></path>
                        <path fill="red" d="m8 4 4 4-4 4-4-4z"></path>
                      </svg>
                      <span className="min-w-[14px] text-center">
                        {matchInfo.redTeam.stats.inhibitors}
                      </span>
                    </div>
                  </div>
                </div>
